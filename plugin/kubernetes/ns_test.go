...
func (APIConnTest) SvcIndex(string) []*index.Service        { return nil }
func (APIConnTest) SvcIndexReverse(string) []*index.Service { return nil }
...
func (APIConnTest) ServiceList() []*index.Service {
	svcs := []*index.Service{
		{
			Name:      "dns-service",
