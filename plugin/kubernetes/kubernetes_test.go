...
func (APIConnServiceTest) SvcIndexReverse(string) []*index.Service { return nil }
...
func (APIConnServiceTest) SvcIndex(string) []*index.Service {
	svcs := []*index.Service{
		{
			Name:      "svc1",
			Namespace: "testns",
...
func (APIConnServiceTest) ServiceList() []*index.Service {
	svcs := []*index.Service{
		{
			Name:      "svc1",
			Namespace: "testns",
