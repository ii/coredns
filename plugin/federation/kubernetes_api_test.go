...
func (APIConnFederationTest) SvcIndexReverse(string) []*index.Service { return nil }
...
func (APIConnFederationTest) SvcIndex(string) []*index.Service {
	svcs := []*index.Service{
		{
			Name:      "svc1",
			Namespace: "testns",
...
func (APIConnFederationTest) ServiceList() []*index.Service {
	svcs := []*index.Service{
		{
			Name:      "svc1",
			Namespace: "testns",
